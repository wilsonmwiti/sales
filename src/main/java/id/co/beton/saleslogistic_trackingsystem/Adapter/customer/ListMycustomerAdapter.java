...
public class ListMycustomerAdapter extends ArrayAdapter<Customer>
    ...
    public ListMycustomerAdapter(@NonNull Context context, int resource, int originLength, boolean isFilter, @NonNull List<Customer> customers){
        ...
        holder.fab_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("customer_id", customers.get(position).getCode());
                    ...
                    customerE.put("latitude", String.valueOf(customer.getLat().toString()));
                    customerE.put("longitude", String.valueOf(customer.getLng().toString()));
...
//                    Log.d("gson", contacts.getName());
    ...
    private void showDialogDeleteCustomer(final Customer customer){
